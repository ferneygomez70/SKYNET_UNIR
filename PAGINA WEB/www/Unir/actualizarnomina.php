...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form3")) {
  $updateSQL = sprintf("UPDATE nomina SET dias=%s, horas_extras=%s WHERE id=%s",
...
mysql_select_db($database_conn, $conn);
$query_Recordset1 = "SELECT * FROM nomina inner join empleados ON  empleados. id_empleado=nomina.id";
          ...
          <ul>
            ...
            <li><a href="#" class="MenuBarItemSubmenu">PROVEEDOR</a>
                <ul>
                  ...
                  <li><a href="estadoproveedor.html">ESTADO DEL PROVEDOR</a></li>
                </ul>
            </li>
          </ul>
      </li>
