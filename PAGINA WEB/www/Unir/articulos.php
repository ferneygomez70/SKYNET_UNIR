...
<table width="1628" border="0" align="left" cellpadding="1" cellspacing="1">
  <tr class="letter">
    <td width="132" align="center" bgcolor="#00A9EC"><h6>Codigo</h6></td>
    <td width="93" align="center" bgcolor="#00A9EC"><h6>Lote</h6></td>
    <td width="120" align="center" bgcolor="#00A9EC">Familia</td>
    <td width="343" align="center" bgcolor="#00A9EC">Producto</td>
    <td width="143" align="center" bgcolor="#00A9EC"><h6>Precio compra</h6></td>
    <td width="222" align="center" bgcolor="#00A9EC">Precio Venta</td>
    <td width="122" align="center" bgcolor="#00A9EC"><h6>Cantidad</h6></td>
    <td width="141" align="center" bgcolor="#00A9EC"><h6>Medida</h6></td>
    <td width="284" align="center" bgcolor="#00A9EC">Opci&oacute;n</td>
  </tr>
  <?php do { ?>
    <tr bgcolor="#CCCCCC"
 onmouseover="this.style.backgroundColor='#00CCFF';"
 onmouseout="this.style.backgroundColor='#CCCCCC';">
      <td align="left"><h6><?php echo $row_Recordset1['cod_product']; ?></h6></td>
      <td><h6><?php echo $row_Recordset1['lote']; ?></h6></td>
      <td align="right"><h6><?php echo $row_Recordset1['familia']; ?></h6></td>
      <td><?php echo $row_Recordset1['nomb_product']; ?></td>
      <td align="right"><h6><?php echo $row_Recordset1['precio_compra']; ?></h6></td>
      <td align="right"><?php echo $row_Recordset1['precio_venta']; ?></td>
      <td align="center"><h6><?php echo $row_Recordset1['inventario']; ?></h6></td>
      <td align="center"><h6><?php echo $row_Recordset1['medida']; ?></h6></td>
