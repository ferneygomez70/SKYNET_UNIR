...
if (isset($_POST['Nit'])) {
  $colname_Recordset1 = (get_magic_quotes_gpc()) ? $_POST['Nit'] : addslashes($_POST['Nit']);
}
mysql_select_db($database_conn, $conn);
$query_Recordset1 = sprintf("SELECT * FROM abonos WHERE Nit = %s", $colname_Recordset1);
...
<form id="form2" name="form2" method="post" action="">
  <table border="2" cellpadding="1" cellspacing="2">
    <tr bgcolor="#993300">
      <td><span class="Estilo21">Orden de abonos </span></td>
      <td><span class="Estilo21">Nit</span></td>
      <td><span class="Estilo21">Cantidad Abonadao</span></td>
      <td><span class="Estilo21">Fecha del Abono</span></td>
    </tr>
    <?php do { ?>
      <tr bgcolor="#FF9900">
        <td><?php echo $row_Recordset1['id_abonos']; ?></td>
        <td><?php echo $row_Recordset1['Nit']; ?></td>
        <td><?php echo $row_Recordset1['abono']; ?></td>
        <td><?php echo $row_Recordset1['fecha_Abono']; ?></td>
      </tr>
