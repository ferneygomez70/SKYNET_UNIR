...
Public Class ingreso
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Btn_terminarfact.Click
        ...
        Else
            GASTOS.TextBox1.Text = Me.Label15.Text
            GASTOS.TextBox2.Text = Me.Txt_proveedor.Text
            'insertar datos desde el listview
            'kkkkkkkkk
            'kkkkkk
            'kkkkkk
            'Dim strSalario As String
            'Dim cmd As New MySqlCommand(strSalario, conexion)

            'For Each Item As ListViewItem In ListView1.Items

            '    cmd.Parameters.Clear()

            '    cmd.Parameters.AddWithValue("@id_empleados", Item.Text)
            '    cmd.Parameters.AddWithValue("@nombre", Item.SubItems(1).Text)
            '    cmd.Parameters.AddWithValue("@apellido1", Item.SubItems(2).Text)
            '    cmd.Parameters.AddWithValue("@apellido2", Item.SubItems(3).Text)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles bTN_INGRESARARTICULO.Click
        ...
        Else
            ...
            'Dim tabla As ListViewItem = New ListViewItem(Txt_articulo.Text)
            'tabla.SubItems.Add(Txt_cantidad.Text)

            'ListBox2.Items.Add((Me.Txt_cantidad.Text) & (" ") & (Me.Txt_articulo.Text) & ("                   ") & (Me.Txt_total.Text) & ("    "))
            'tabla.SubItems.Add(Txt_preciocompra.Text)
            'tabla.SubItems.Add(Txt_total.Text)
            'ListView1.Items.Add(tabla)
            'ListView1.View = View.Details
            'Label20.Text = Val(Txt_cantidad.Text) + Val(TextBox13.Text)
            ...
            '    If varconex.State = ConnectionState.Open Then varconex.Close()
            '    varconex.Open()
            '    Queryw = "update articulos set inventario='" & Label20.Text & "', precio_compra='" & Txt_preciocompra.Text & "',proveedor='" & Txt_proveedor.Text & "', precio_venta='" & Txt_precioventa.Text & "' where articulos.cod_product='" & TextBox6.Text & "' "
    ...
    Private Sub facturas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'ListBox2.Items.Add("Cantidad|Articulo    |Precio Unidad| Total ")
        Xdist = New Distrito(Txt_articulo.Text, Txt_cantidad.Text, Txt_preciocompra.Text, Txt_total.Text)


        'ListView1.Columns.Add("Articulo", 100, HorizontalAlignment.Center)
    ...
    Private Sub DataGridView1_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        'Nueva Linea 04/08/2014 Pedro Pablo Ospino Betancourt
