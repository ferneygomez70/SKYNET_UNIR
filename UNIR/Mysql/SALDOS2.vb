...
Public Class SALDOS2
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            ...
            VENTAS2.Label11.Text = total
            VENTAS2.Label6.Text = Label2.Text
            VENTAS2.Label7.Text = Label1.Text
            VENTAS2.Label13.Text = Label3.Text
            VENTAS2.Label8.Text = MaskedTextBox1.Text
            VENTAS2.Label29.Visible = False

            VENTAS2.TextBox2.Text = Label5.Text
