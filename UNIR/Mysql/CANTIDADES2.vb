...
Public Class CANTIDADES2
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            ...
            VENTAS2.Label8.Text = Label5.Text
            VENTAS2.Label7.Visible = True
            VENTAS2.Label7.Text = nombre
            VENTAS2.Label13.Text = medida
            VENTAS2.Label31.Text = iva
            VENTAS2.TextBox2.Visible = True
            VENTAS2.TextBox2.Text = Me.NumericUpDown1.Text
            ...
            If ((promocion = 0) And (NumericUpDown1.Text >= cant)) Then
                ...
                VENTAS2.Label35.Text = totaliva
                VENTAS2.Label5.Visible = False
                VENTAS2.Label11.Text = totalfinal
