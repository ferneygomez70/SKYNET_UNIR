...
Public Class LOGIN_BORRADO2
    ...
    Private Sub Form5_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        If e.KeyCode = Keys.F10 Then
            VENTAS2.Label16.Text = Label20.Text
            VENTAS2.Label1.Text = Label19.Text
            VENTAS2.Label22.Text = Label16.Text
            VENTAS2.Label9.Text = Label3.Text
            VENTAS2.Label12.Text = Label13.Text
            VENTAS2.TextBox1.Enabled = True
            VENTAS2.DataGridView1.Enabled = True
            VENTAS2.Button1.Enabled = True
            VENTAS2.Button3.Enabled = True
            VENTAS2.TraeConfiguracion()



            Me.Close()
            VENTAS2.DataGridView1.Refresh()
            VENTAS2.Show()
        End If
    End Sub
    ...
    Private Sub validaruser()
        ...
        Dim sqlquery As String = "SELECT * FROM usuarios  WHERE user='" & TextBox1.Text & "' AND clave='" & TextBox2.Text & "' and id_tipouser = 3 OR 1"
        ...
        If mydata.HasRows = 0 Then
            MsgBox("USUARIO INVALIDO: Datos Incorrectos")
            conexion.Close()
            TextBox2.Focus()
        Else
