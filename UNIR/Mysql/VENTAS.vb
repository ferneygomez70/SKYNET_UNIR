...
Public Class VENTAS
    ...
    Private Sub FormVenta_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        If e.KeyCode = Keys.F1 Then
            ...
            Else
                puertoserial.Close()
                COBRAR.Label14.Text = Label1.Text
                COBRAR.Label15.Text = Label16.Text
                COBRAR.Label3.Text = Label9.Text
                COBRAR.Label4.Text = Label12.Text
                COBRAR.Label2.Text = total_venta.Text
                COBRAR.Label27.Text = Label37.Text
                COBRAR.Label9.Text = Label22.Text
                COBRAR.Label12.Text = Label38.Text
        ...
        If e.KeyCode = Keys.F4 Then
            ...
            Else
                CANTIDADES.Label2.Text = Label5.Text
    ...
    Public Sub numfact()
        ...
        If lectura_fact.Read() Then
            ...
            VariablesGoblales.NoFact = lectura_fact.Item("id_fact")
        End If
    ...
    Public Sub factura()
        ...
        Else
            ...
            Dim fact As String
            fact = "insert into facturas (id_caja,id_usuarios,fecha_fact,venta_factura) value ('" & Me.Label12.Text & "','" & Me.Label9.Text & "','" & Me.Label4.Text & "',1)"
            varconex.Open()
    ...
    Public Sub insertar(Saldo As Integer)
        ...
        If Saldo = 0 Then
            Dim NoFact As String = "select id_venta,id_fact,articulos.id_product,articulos.promocion,articulos.cant_prom,articulos.valor_prom,cant,peso,valor_unitario,precio,articulos.iva,valor_iva " & "from ventas inner join articulos on ventas.id_product=articulos.id_product " &
    ...
    Private Sub FormVenta_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        VENTAS2.puertoserial2.Close()

        If VariablesGoblales.PrecioPorMayor = True Then
            CbxMayorista.Visible = True
        Else
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnIngresar.Click
        ...
        If VariablesGoblales.Bascula = True Then 'control para mostrar solo productos  sin y con bascula
            cadena3 = "select articulos.id_product,articulos.iva,articulos.cod_product,articulos.inventario,articulos.nomb_product,articulos.precio_venta,articulos.PrecioPorMayor,medida.id_medida,medida.medida,articulos.promocion,articulos.cant_prom,articulos.valor_prom from articulos INNER JOIN medida ON (articulos.id_medida = medida.id_medida) WHERE articulos.cod_product= '" & TextBox1.Text & "' OR nomb_product LIKE  '%" & TextBox1.Text & "%'"
        Else
            cadena3 = "select articulos.id_product,articulos.iva,articulos.cod_product,articulos.inventario,articulos.nomb_product,articulos.precio_venta,articulos.PrecioPorMayor,medida.id_medida,medida.medida,articulos.promocion,articulos.cant_prom,articulos.valor_prom from articulos INNER JOIN medida ON (articulos.id_medida = medida.id_medida) and medida.id_medida= 2 WHERE    articulos.cod_product= '" & TextBox1.Text & "' OR nomb_product LIKE  '%" & TextBox1.Text & "%'"
        End If
        ...
        If codata.Tables(0).Rows.Count = 0 Then
            MessageBox.Show("El producto digitado no es valido")
            TextBox1.Text = ""
            Exit Sub
        ...
        ElseIf codata.Tables(0).Rows.Count = 1 Then
            ...
            precioPorMayor = codata.Tables(0).Rows(0).Item("PrecioPorMayor")
            ...
            Me.Label31.Text = iva
            Me.LblPrecioPorMayor.Text = precioPorMayor
        ...
        If producto = "" Then
            ...
            BuscarProducto.Label2.Text = Label5.Text
            BuscarProducto.ShowDialog()

            BuscarProducto.TextBox1.Focus()
        End If
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        '' se cambia todo para ver si queda igual que cuando se oprome la tecla f1
    ...
    Private Sub estacompra()
        Try
            ...
            If VariablesGoblales.Bascula = True Then 'control para mostrar bascula
                DataGridView1.Columns(4).Width = 50
                'DataGridView1.Columns(4).Visible = False
            Else
                DataGridView1.Columns(4).Width = 5
                DataGridView1.Columns(4).Visible = False
    ...
    Public Sub empresa()
        ...
        Try
            ...
            conexion.Close()
        Catch ex As Exception
            MsgBox("fallo en lectura nombre de empresa de la tabla empresa", vbExclamation, "Atención      SKYNET")
        End Try
    End Sub
    ...
    Public Sub total()
        ...
        conexion.Close()
    End Sub
    Public Sub total_descuentos()

        ' para que funcione el id de descuento debe ser 82
        Try
            Me.Label37.Text = 0

            Dim cmd As New MySqlCommand("SELECT SUM(ventas.precio) AS TOTAL_descuento FROM ventas WHERE ventas.activo = 1  and id_product=82 and ventas.id_fact=" & Me.Label22.Text & "", conexion)
            ...
            lectura = cmd.ExecuteReader
            If lectura.Read() Then
                Me.Label37.Text = lectura.Item("TOTAL_descuento")
                Me.Label49.Text = CStr(Math.Round(lectura.Item("TOTAL_descuento") / 50) * 50)
            End If
    ...
    Private Sub DataGridView1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles DataGridView1.KeyDown
        ...
        If e.KeyCode = Keys.Enter Then
            ...
            LOGIN_BORRADO.Label1.Text = idventa
            LOGIN_BORRADO.Label20.Text = Label16.Text
            LOGIN_BORRADO.Label19.Text = Label1.Text
            LOGIN_BORRADO.Label3.Text = Label9.Text
            LOGIN_BORRADO.Label13.Text = Label12.Text
            LOGIN_BORRADO.Label16.Text = Label22.Text
            TraeConfiguracion()
            Me.Close()
            'Me.Visible = False
            TextBox1.Focus()
            LOGIN_BORRADO.ShowDialog()
        End If
    End Sub
    ...
    Private Sub ToolStripButton3_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton3.Click
        If Label30.Text = 1 Then
            SALDOS.MaskedTextBox1.Focus()
            SALDOS.Label4.Text = Me.TextBox2.Text
            SALDOS.ShowDialog()
        Else
            MsgBox("favor inicie venta con F2", vbExclamation, "Atención      SKYNET")
        End If
